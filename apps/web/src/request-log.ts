...
const PREFIXES = ["/api/github/public/", "/api/github/user/", "/api/github/write/", "/api/auth/", "/_serverFn/", "/assets/"];
...
export async function withErrorLog(request: Request, handle: () => Promise<Response>): Promise<Response> {
